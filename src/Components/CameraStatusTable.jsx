...
const rows = [
  {
    ...
    role: "Owner",
    location: "Adam Stall",
    sub_location: "Coimbatore",
    last_active: "Sep 13, 2023 5:51 PM",
...

  {
    ...
    location: "MMDA",
    sub_location: "Coimbatore",
    last_active: "Today, 2023 2:11 PM",
            ...
            {rows.map((row) => (
              <StyledTableRow key={row.id}>
                ...
                <StyledTableCell align="center">
                  <span className="flex">
                    {" "}
                    <FaRegEdit className="text-xl font-bold" />{" "}
                    <RiDeleteBin6Line className="text-xl font-bold text-red-500 ml-2" />
                  </span>
                </StyledTableCell>
              </StyledTableRow>
            ))}
